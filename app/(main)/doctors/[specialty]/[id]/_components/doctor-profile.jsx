            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <Button
                  ...
                  className="w-full bg-emerald-600 hover:bg-emerald-700 mt-4 disabled:bg-gray-600 disabled:text-gray-400 disabled:cursor-not-allowed"
                >
                  {totalSlots === 0 ? (
                    <>
                      No Slots Available
                ...
                {totalSlots === 0 && (
                  <Alert className="mt-3 border-yellow-600/30 bg-yellow-900/20">
                    ...
                    <AlertDescription className="text-yellow-200">
                      This doctor hasn&apos;t set their availability yet. Please check back later or contact support.
                    </AlertDescription>
                  </Alert>
                )}
              </div>
